...
public class thongKeDonNhap extends thongKe implements thongKeTheoThoiGian{
    ...
    public void thongKeTheoThang(){
        ...
        for(int i = 0; i < 12; i++){
            ...
            System.out.println("Tong gia nhap thang : " + (i + 1) + " : " + soTienNhapThang[i]);
        }
    }
    @Override
    public void thongKeTheoQuy(){
        ...
        for(int i = 0; i < 4; i++){
            ...
            System.out.println("Tong gia nhap quy : " + (i + 1) + " : " + soTienNhapQuy[i]);
        }
    }
    @Override
    public void thongKeTheoNam(){
        ...
        System.out.println("Tong gia nhap nam : " + namNhap + " : " + soTienNhapNam);
    }
}
